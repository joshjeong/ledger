...
l6 = josh.ledgers.create(item: "Phone", price: 300, note: "iPhone 6", payment_type: "Credit", expenditure:"Electronic")
l7 = josh.ledgers.create(item: "Candy", price: 1, note: "Snickers", payment_type: "Cash", expenditure:"Food")
